 ...
 *
 * End what os-sso granted and should not still hold: an access past its absolute
 * lifetime, one belonging to an account that has since been disabled, and the records
 * of sessions that are gone anyway.
 *
 ...
 * us -- least of all a captive-portal client or a VPN tunnel, which never make one at
 * all. Hence this: the plugin schedules it for itself under System > Settings > Cron
 * ("os-sso: expire SSO sessions"), and it also runs opportunistically on every SSO
 * login.
 */
